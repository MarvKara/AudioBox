...
namespace Crowdsound_Slave_Server_Application.Support
{
    ...
    public static class Settings
    {
        ...
        private const string FILENAME = "settings.abs";
        ...
        private const string INIT_SERVER_ID = "NONE";
        private const string INIT_SECRET = "NONE";
        ...
        public static void Initialize()
        {
            ...
            SERVER_ID = (string)Load("SERVER_ID");
            SECRET = (string)Load("SECRET");
        }
        ...
        private static object Load(string setting)
        {
            ...
            switch (setting)
            {
                ...
                case "SERVER_ID":
                    {
                        var result = settings[3];
                        return result;
                    }
                case "SECRET":
                    {
                        var result = settings[4];
                        return result;
                    }
                default:
                    {
        ...
        public static void Save(List<object> settings)
        {
            ...
            SERVER_ID = (string)settings[3];
            SECRET = (string)settings[4];
        ...
        private static void SetInitial()
        {
            ...
            writer.WriteLine(INIT_SERVER_ID);
            writer.WriteLine(INIT_SECRET);
            writer.Flush();
            writer.Close();
        }
