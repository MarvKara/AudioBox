using Crowdsound_Master_Server_Application.Modules.ServerCommandInterface.Commands;
    ...
    public static class CommandParser
    {
        public static ICommand Parse(string input)
        {
            ...
            switch (commandWord)
            {
                case "AUTHSERVER":
                    {
                        command = new AUTHSERVER(commandWord, new string[] { parameter1, parameter2, parameter3});
                        break;
                    }
                default:
                    {
