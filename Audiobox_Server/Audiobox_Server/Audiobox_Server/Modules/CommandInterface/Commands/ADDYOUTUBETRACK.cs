...
{
    /// <summary>
    /// Command / ICommand-Object for Command ADDYOUTUBETRACK
    /// Parameter1 :: USERID
    /// Parameter2 :: URL
    /// #######################################################
    /// Copyright: Marvin Karaschewski, Stenden Hogeschool 2013
    /// </summary>
    public class ADDYOUTUBETRACK : Command, ICommand
    {        
        ...
        public ADDYOUTUBETRACK(string keyword, string[] parameters, UserAuthorization userAuthorization)
        ...
        {
            SessionManager.AddYoutubeTrackToQueue(this.Parameters[0], this.Parameters[1]);
            //YoutubeDownloadManager.AddDownloadToQueue(this.Parameters[1], SessionManager.FindSessionByUserId(this.Parameters[0]).Id);
            return string.Empty;
        }
    }
}