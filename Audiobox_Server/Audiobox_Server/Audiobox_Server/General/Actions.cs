...
namespace Audiobox_Server.General
{
    ...
    public static class Actions
    {
        ...
        /// <summary>
        /// Cleans up all Session related folders
        /// </summary>
        public static void CleanUpSessionFolders()
        {
            if (Directory.Exists(GeneralObjects.SESSION_FOLDERNAME))
            {
                DeleteFolder(GeneralObjects.SESSION_FOLDERNAME);
            }
        }

        /// <summary>
        /// Creates all folderstructures needed to run the application properly
        /// </summary>
        public static void CreateFolderStructures()
        {
            if (Directory.Exists(GeneralObjects.SESSION_FOLDERNAME))
            {
                DeleteFolder(GeneralObjects.SESSION_FOLDERNAME);
                CreateFolder(GeneralObjects.SESSION_FOLDERNAME);
            }
            else
            {
                CreateFolder(GeneralObjects.SESSION_FOLDERNAME);
